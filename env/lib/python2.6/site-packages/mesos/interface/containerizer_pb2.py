...
_TERMINATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='mesos.containerizer.Termination.status', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='state', full_name='mesos.containerizer.Termination.state', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reasons', full_name='mesos.containerizer.Termination.reasons', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='message', full_name='mesos.containerizer.Termination.message', index=3,
...
_TERMINATION.fields_by_name['state'].enum_type = mesos_pb2._TASKSTATE
_TERMINATION.fields_by_name['reasons'].enum_type = mesos_pb2._TASKSTATUS_REASON
