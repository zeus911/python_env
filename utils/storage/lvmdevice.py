...
from partition import PhysicalVolume
from parteddata import physicalVolume, volumeGroup, logicalVolume 
from errors import *

class PhysicalVolume(object):
    _type = physicalVolume

    def __init__(self, t, size=None, uuid=None, peSize=None, peCount=None, peFree=None, existing=0):
        """
...
class VolumeGroup(object):
    ...
    def __init__(self, name, size=None, uuid=None, 
        ...
        Existing VG
            ...
            pvs -- a list of physical volumes. ts of this VG
...
class LogicalVolume():
    ...
    def destroy(self):
        if not self.exists:
            ...
            self.teardown()
            #Setup ts( maybe raid parts) so lvm can remove lv
            #FIXME:fix self.setupts()
            self.vg.setupts()
