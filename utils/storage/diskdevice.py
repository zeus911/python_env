...
from partition import Partition, PhysicalVolume, RaidMember, FreeSpace
from errors import DeviceError, DiskError
import utils.sysutils as sysutils
from filesystem import getFilesystem, FileSystem
from parteddata import disk

import logging
log = logging.getLogger("diskdevice")
...
class Disk:
    ...
    def _addPartition(self, part):
        self._partitions.append(self._getartition(part))
