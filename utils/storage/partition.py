...
from filesystem import FileSystem, getFilesystem
from parteddata import partition, physicalVolume, raidMember, freeSpace
from errors import *
import gettext
_ = lambda x:gettext.ldgettext("partition", x)
...
class Partition:
    ...
    ##
    # is equal? comthe partiton start/ends
    # @param: Partition
    # returns: Boolean
    def __eq__(self, rhs):
